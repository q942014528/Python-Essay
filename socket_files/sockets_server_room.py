...
class full_duplex(object):
            ...
            for fileno,event in events:
                if fileno == self.soc.fileno():
                    ...
                    if not data:
                        ...
                        if tcp_client[1]:
                            self.Delete_chatroom(tcp_client)
                            tcp_client[1] = 0
                    ...
                    if tcp_client[1]==0:
                        ...
                        #更新房间人数
                        self.room_dict[tcp_client[1]] = num
    ...
    def Delete_chatroom(self,tcp_client):
        print"---------------------"
        self.room_dict[tcp_client[1]]-=1
        if self.room_dict[tcp_client[1]]==0:
            self.room_list.remove(tcp_client[1])
            print"%d号聊天室以关闭"%tcp_client[1]
